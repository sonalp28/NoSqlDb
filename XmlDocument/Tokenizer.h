...
//<--------------------------------------this inline function returns comments if any present--------------------------------------------->
inline void Toker::returnComments(bool doReturn){ doReturnComments = doReturn; }

//<-----------------------this inline function returns bool for whether the file reading reached at end or not---------------------------->
inline bool Toker::isFileEnd() { return (nextChar == -1); }

//<----------------------------------this inline function returns total number of lines in the file--------------------------------------->
inline int& Toker::lines() { return numLines; }

//<-----------------------------------------this inline function returns brace count------------------------------------------------------>
