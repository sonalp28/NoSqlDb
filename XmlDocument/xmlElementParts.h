...
//<------------------------------------------constructor that initilizes private member pToker---------------------------------------------------->
inline XmlParts::XmlParts() : pToker(nullptr) {}

//<------------------------------------------this inline function gives the size of token--------------------------------------------------------->
inline int XmlParts::length() { return (int)toks.size(); }

//<------------------------------------------------this inline function check for verbose--------------------------------------------------------->
inline void XmlParts::verbose(bool v) { Verbose = v; }

//<------------------------------------------------this inline function clears the tokens--------------------------------------------------------->
inline void XmlParts::clear() { toks.clear(); }

//<-------------------------------------this inline function inserts new tokens into tok vector--------------------------------------------------->
