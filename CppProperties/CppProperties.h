...
* Public Interface :
* ------------------
* inline std::ostream& operator<<(std::ostream& out, Property<std::string>& p) - overload insertion operator for std::string properties
* inline std::ostream& operator<<(std::ostream& out, Property<const std::string>& p) - overload insertion operator for std::string properties
*
* Build Process:
* --------------
