...
* Public Interface:
* -------------------
* char* DateTime::ctime(const std::time_t* pTime) - replaces std::ctime using ctime_s
* std::tm* DateTime::localtime(const std::time_t* pTime) - replaces std::localtime using localtime_s
* DateTime::DateTime() - construct DateTime instance with current system time
* int readDateTimePart(int& part, std::istringstream& in) - Helper function that reads each part of the formatted string
* DateTime::DateTime(std::string dtStr) - Throws exception if string is an invalid DateTime string
* DateTime::operator std::string() - cast operator converts to time formatted string
* DateTime::DateTime(const DateTime::TimePoint& tp) : tp_(tp) - construct DateTime instance from time point
* DateTime::TimePoint DateTime::makeTime(size_t year, size_t mon, size_t day, size_t hour, size_t min, size_t sec) - make a time from integral parts
* DateTime::Duration DateTime::makeDuration(size_t hour, size_t min, size_t sec, size_t millisec) - make a duration from integral parts
* std::string DateTime::now() - set time to system time
* DateTime::TimePoint DateTime::timepoint() - return internal time point
* size_t DateTime::ticks() - return seconds from Jan 1 1990 at midnight
* std::string DateTime::time() - return formatted time string
* bool DateTime::operator<(const DateTime& dt) - compare DateTime instances
* bool DateTime::operator>(const DateTime& dt) - compare DateTime instances 
* DateTime DateTime::operator+=(const DateTime::Duration& dur) - add a duration to DateTime instance
* DateTime DateTime::operator+(const DateTime::Duration& dur)- make DateTime from instance time plus duration 
* DateTime DateTime::operator-=(const DateTime::Duration& dur) - subtract a duration from instance 
* DateTime DateTime::operator-(const DateTime::Duration& dur) - make DateTime from instance time minus duration 
* size_t DateTime::year() - return year count 
* size_t DateTime::month() - return month count 
* size_t DateTime::day() - return day count
* size_t DateTime::hour() - return hour count 
* size_t DateTime::minute() - return minutes count 
* size_t DateTime::second() - return seconds count *
*
*
* Required Files:
* ---------------
